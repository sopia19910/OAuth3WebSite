    ...
    <section id="contact" className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[hsl(0,0%,20%)] mb-4">Contact Us</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="bg-[hsl(210,40%,96%)] border-none">
            <CardContent className="p-8">
              <h3 className="text-2xl font-semibold text-[hsl(0,0%,20%)] mb-6">Send us a message</h3>
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <Input
                      ...
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[hsl(217,91%,60%)]"
                    />
                  </div>
                  <div>
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[hsl(217,91%,60%)] hover:bg-[hsl(217,91%,55%)] text-white py-3 font-semibold"
                >
                  Send Message
                </Button>
              </form>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-semibold text-[hsl(0,0%,20%)] mb-6">Get in touch</h3>
            ...
            <div className="space-y-6">
              {contactMethods.map((method, index) => (
                <div key={index} className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-[hsl(0,0%,20%)]">{method.title}</h4>

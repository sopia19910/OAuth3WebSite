...
export default function AboutSection() {
  const features = [
    {
      icon: <Lightbulb className="w-12 h-12 text-[hsl(217,91%,60%)] mb-4" />,
    ...
    {
      icon: <Settings className="w-12 h-12 text-[hsl(217,91%,60%)] mb-4" />,
    ...
    {
      icon: <Lock className="w-12 h-12 text-[hsl(217,91%,60%)] mb-4" />,
  ...
  return (
    <section id="about" className="py-20 bg-[hsl(210,40%,96%)]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[hsl(0,0%,20%)] mb-4">About OAuth 3</h2>
            ...
            <Card key={index} className="bg-white shadow-lg card-hover">
              <CardContent className="p-8">
                <div className="text-center mb-6">
                  {feature.icon}
                  <h3 className="text-2xl font-semibold text-[hsl(0,0%,20%)] mb-4">{feature.title}</h3>
                </div>
                  ...
                  <ul className="space-y-2">
                    {feature.features.map((item, itemIndex) => (
                      <li key={itemIndex} className="flex items-center text-gray-600">
                        <Check className="w-4 h-4 text-[hsl(217,91%,60%)] mr-2" />
                        {item}
                      </li>
                    ))}
                  </ul>

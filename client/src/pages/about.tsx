      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">The Problem: Web2 vs. Web3</h2>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">The Solution: What is OAuth 3?</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto tech-body">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">Security Architecture</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto tech-body">
            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-center justify-center space-y-6 md:space-y-0 md:space-x-8">
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Web2 Login</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Web3 Signature</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-foreground mb-2">Secure Transaction</h3>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">OAuth 3 vs Traditional Models</h2>
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">Real-World Applications</h2>
          </div>
              ...
              <Card key={index} className="bg-card shadow-lg card-hover">
                <CardContent className="p-8">
                  <div className="text-center mb-8">
                    {app.icon}
                    <h3 className="text-2xl font-semibold text-foreground mb-4">{app.title}</h3>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-foreground mb-4 professional-heading">Incentivized Ecosystem</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto tech-body">
            ...
            <CardContent className="p-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-4">User Incentives</h3>
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-semibold text-foreground mb-4">Enterprise Rewards</h3>
                  <p className="text-muted-foreground">
        ...
        {/* Future Section */}
        <div className="text-center">
          <h2 className="text-3xl font-bold text-foreground mb-6 professional-heading">The Future of Authentication</h2>

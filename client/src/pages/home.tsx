        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <KeyIcon className="w-6 h-6 text-primary" strokeWidth={2} />
                </div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <GlobeAltIcon className="w-6 h-6 text-primary" strokeWidth={2} />
                </div>
                <div>
              ...
              <div className="pt-4">
                <Link href="/about">
                  <Button size="sm" variant="outline" className="border-gray-400 text-gray-600 text-xs hover:bg-gray-100 hover:border-gray-500 hover:text-gray-700 hover:opacity-50 transition-all">
                    Learn More
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative h-full bg-gradient-to-br from-card to-card/50 backdrop-blur border border-border/50 rounded-2xl p-8 hover:shadow-2xl hover:border-primary/50 transition-all duration-300">
                ...
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary/20 to-primary/5 rounded-2xl flex items-center justify-center mb-6">
                    <UsersIcon className="w-8 h-8 text-primary" strokeWidth={2} />
                  </div>
              ...
              <div className="relative h-full bg-gradient-to-br from-card to-card/50 backdrop-blur border border-border/50 rounded-2xl p-8 hover:shadow-2xl hover:border-accent/50 transition-all duration-300">
                ...
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br from-accent/20 to-accent/5 rounded-2xl flex items-center justify-center mb-6">
                    <CogIcon className="w-8 h-8 text-accent" strokeWidth={2} />
                  </div>
            ...
            <div className="group">
              <div className="relative h-full bg-gradient-to-br from-card to-card/50 backdrop-blur border border-border/50 rounded-2xl p-8 hover:shadow-2xl hover:border-primary/50 transition-all duration-300">
                ...
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-br from-primary/20 to-primary/5 rounded-2xl flex items-center justify-center mb-6">
                    <ShieldCheckIcon className="w-8 h-8 text-primary" strokeWidth={2} />
                  </div>
          ...
          <div className="text-center mt-10">
            <Link href="/technology">
              <Button size="sm" variant="outline" className="border-gray-400 text-gray-600 text-xs hover:bg-gray-100 hover:border-gray-500 hover:text-gray-700 hover:opacity-50 transition-all duration-300">
                Learn More
                <ArrowRightIcon className="ml-2 w-3 h-3" />
              </Button>
            </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
              ...
              <div className="relative h-full bg-gradient-to-br from-card to-card/80 border border-border/50 rounded-3xl p-8 hover:shadow-2xl hover:border-primary/50 transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-primary/20 to-primary/10 rounded-2xl flex items-center justify-center">
                    <UsersIcon className="w-7 h-7 text-primary" strokeWidth={2} />
                  </div>
                  <div>
            ...
            <div className="group relative">
              ...
              <div className="relative h-full bg-gradient-to-br from-card to-card/80 border border-border/50 rounded-3xl p-8 hover:shadow-2xl hover:border-accent/50 transition-all duration-300">
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-14 h-14 bg-gradient-to-br from-accent/20 to-accent/10 rounded-2xl flex items-center justify-center">
                    <BuildingOfficeIcon className="w-7 h-7 text-accent" strokeWidth={2} />
                  </div>
                  <div>
